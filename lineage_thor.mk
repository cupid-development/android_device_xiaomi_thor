...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="thor-user 14 UKQ1.231003.002 V816.0.5.0.ULACNXM release-keys" \
    TARGET_DEVICE=$(PRODUCT_SYSTEM_DEVICE) \
    TARGET_PRODUCT=$(PRODUCT_SYSTEM_NAME)

BUILD_FINGERPRINT := Xiaomi/thor/thor:14/UKQ1.231003.002/V816.0.5.0.ULACNXM:user/release-keys
